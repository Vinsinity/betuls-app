                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="{{ route('admin.products.brands.add') }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Brand</a>
                                </div>
                        ...
                        <table class="table table-ecommerce-simple table-borderless table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
                            ...
                            @foreach($brands as $brand)
                                <tr>
                                    ...
                                    <td><a href="ecommerce-orders-detail.html"><strong>{{ $brand->id }}</strong></a></td>
                                    <td><a href="ecommerce-orders-detail.html"><strong>{{ $brand->name }}</strong></a></td>
