                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="{{ route('admin.products.categories.add') }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Category</a>
                                </div>
                        ...
                        <table class="table table-ecommerce-simple table-borderless table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td><a href="ecommerce-orders-detail.html"><strong>{{ $category->id }}</strong></a></td>
                                    <td><a href="ecommerce-orders-detail.html"><strong>{{ $category->name }}</strong></a></td>
