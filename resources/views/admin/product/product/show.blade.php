                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center pb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="name" id="name" value="{{ $product->name }}" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="detail" class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Product Description</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <textarea class="form-control form-control-modern" name="detail" id="detail" rows="6" required>{{ $product->detail }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="brand_id" class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Product Brand</label>
                                    <div class="col-lg-7 col-xl-6">
                                ...
                                <div class="form-group row">
                                    <label for="brand_id" class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Product Category</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <div id="categoryTree">
                                            <ul>
                                                @foreach($categories as $category)
                                                    <li id="{{ $category->id }}">
                                                        {{ $category->name }} - {{ $category->children()->count() }}
                                                        @if($category->children()->count() > 0)
                                                            @include('admin.product.category.child', ['category' => $category->children])
                                                        @endif
                                                    </li>
                                                @endforeach
                                            </ul>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Product Uploaded Images</h2>
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center">
                                    @foreach($product->images as $images)
                                        <div class="col-3">
                                            <img width="100%" src="{{ asset(Storage::url('image/products/'.$images->image)) }}" alt="">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
...
{{--                                <div class="form-group row align-items-center">--}}
{{--                                    <div class="col">--}}
{{--                                        <div id="dropzone-form-product-image" class="dropzone-modern dz-square">--}}
                                ...
                                <div class="tab-content" id="tabContent">
                                    <div class="tab-pane fade show active" id="price" role="tabpanel" aria-labelledby="price-tab">
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern" name="price" id="price" value="{{ $product->price }}" required />
                                            </div>
                                        </div>
                                    </div>
...
@push('specificJs')
    ...
    <script src="{{ asset('admin/assets/vendor/jstree/jstree.js') }}"></script>
@endpush
@push('examplesJs')
    <script src="{{ asset('admin/assets/js/examples/examples.header.menu.js') }}"></script>
    <script src="{{ asset('admin/assets/js/products/product/betuls.product.form.js') }}"></script>
@endpush
