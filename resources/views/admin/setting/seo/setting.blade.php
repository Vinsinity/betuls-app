                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" id="site_title" name="site_title" value="{{ $settings->site_title }}" required />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
...
{{--                                        <input type="text" class="form-control form-control-modern" id="site_title" name="site_title" value="" required />--}}
                                        <textarea class="form-control form-control-modern" name="site_description" id="site_description" cols="30" rows="3">{{ $settings->site_description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        {{--                                        <input type="text" class="form-control form-control-modern" id="site_title" name="site_title" value="" required />--}}
                                        <textarea class="form-control form-control-modern" name="site_keywords" id="site_keywords" cols="30" rows="3">{{ $settings->site_keywords }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        {{--                                        <input type="text" class="form-control form-control-modern" id="site_title" name="site_title" value="" required />--}}
                                        <textarea class="form-control form-control-modern" name="site_robots" id="site_robots" cols="30" rows="6">{{ $settings->site_robots }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    <label for="site_sitemap" class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Sitemap</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" id="site_sitemap" name="site_sitemap" value="{{ $settings->site_sitemap }}" disabled />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    <label for="site_rss" class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">RSS Feed</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" id="site_rss" name="site_rss" value="{{ $settings->site_rss }}" disabled />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        {{--                                        <input type="text" class="form-control form-control-modern" id="site_title" name="site_title" value="" required />--}}
                                        <textarea class="form-control form-control-modern" name="site_google_verify" id="site_google_verify" cols="30" rows="4">{{ $settings->site_google_verify }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
