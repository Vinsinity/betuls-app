...
<header class="header header-nav-menu header-nav-links">
    <div class="logo-container">
        <a href="../" class="logo">
            <img src="{{ asset('admin/assets') }}/img/logo-modern.png" class="logo-image" width="90" height="24" alt="Porto Admin" /><img src="{{ asset('admin/assets') }}/img/logo-default.png" class="logo-image-mobile" width="90" height="41" alt="Porto Admin" />
        </a>
    ...
    <div class="header-right">
        ...
        <a class="dropdown-language nav-link" href="#" role="button" id="dropdownLanguage" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="{{ asset('admin/assets') }}/img/blank.gif" class="flag flag-us" alt="English" /> EN
            <i class="fas fa-chevron-down"></i>
        </a>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
            <a class="dropdown-item" href="#"><img src="{{ asset('admin/assets') }}/img/blank.gif" class="flag flag-us" alt="English" /> English</a>
            <a class="dropdown-item" href="#"><img src="{{ asset('admin/assets') }}/img/blank.gif" class="flag flag-es" alt="English" /> Español</a>
            <a class="dropdown-item" href="#"><img src="{{ asset('admin/assets') }}/img/blank.gif" class="flag flag-fr" alt="English" /> Française</a>
        </div>
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-bs-toggle="dropdown">
                ...
                <div class="profile-info profile-info-no-role" data-lock-name="{{ Auth::guard('admin')->user()->name }}" data-lock-email="{{ Auth::guard('admin')->user()->email }}">
                    <span class="name">Hi, <strong class="font-weight-semibold">{{ Auth::guard('admin')->user()->name }}</strong></span>
                </div>
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a role="menuitem" tabindex="-1" href="{{ route('admin.auth.logout') }}"><i class="bx bx-log-out"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
