<li class="top-cart">
    <a href="javascript:void(0)"><i class="flaticon-bag"></i><span>{{ $cart->count() }}</span></a>
{{--    <a href="javascript:void(0)"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ({{ $cart_count }})</a>--}}
    <div class="cart-drop">
        @if(count($cart) > 0)
