        ...
        <div class="row">
            @foreach($this->cargos as $cargo)
                <div class="col-md-4 col-lg-4 col-sm-4">
                    ...
                    <label class="w-100">
                        <input type="radio" name="cargo" wire:change="cargoSelected({{$cargo}})" class="card-input-element" {{ $loop->first ? 'checked' : '' }}/>
{{--                        <input type="radio" name="cargo" wire:change="cargoSelected({{$cargo}})" class="card-input-element" {{ $loop->iteration == 1 ? 'checked' : '' }}/>--}}
    ...
    <div class="col-md-4 mb-4">
        ...
        <ul class="list-group mb-3 sticky-top">
            ...
            @if(isset($this->cargo))
                <li class="list-group-item d-flex justify-content-between">
                    <span>Cargo</span>
                    <strong>₺{{ number_format(($this->cargo->price / 100),2,',','.') }}</strong>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total</span>
                    <strong>₺{{ Cart::total() }} + {{ number_format(($this->cargo->price / 100),2,',','.') }}</strong>
                </li>
            @else
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total</span>
